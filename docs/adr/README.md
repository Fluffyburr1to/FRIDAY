...
| [0047](0047-egress-hosts-are-exact-and-a-pattern-is-a-separate-decision.md) | Egress hosts are exact, and a pattern is a separate decision | **proposed** | low | [14](../01-bible/14-connector-framework.md) |
